...
export const siteConfig: SiteConfig = {
	...
	// 站点 URL
	site_url: "https://xiesl97.github.io",

	// 站点描述
	description: "Meotor 的个人博客。",

	// 站点关键词
	keywords: ["Meotor", "谢升伦", "博客"],
	...
	navbar: {
		...
		// 5. Emoji: { type: "emoji", value: "🌠" }
		logo: {
			type: "image",
			value: "/favicon/emoji_u1f320.svg",
			alt: "🌠",
		},
		// 导航栏标题
		title: "Meotor",
